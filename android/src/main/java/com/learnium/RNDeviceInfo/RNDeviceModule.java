...
public class RNDeviceModule extends ReactContextBaseJavaModule {
	...
	public void isLocationEnabled(Promise p) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
			...
			int locationMode = Settings.Secure.getInt(reactContext.getContentResolver(), Settings.Secure.LOCATION_MODE,
					Settings.Secure.LOCATION_MODE_OFF);
			locationEnabled = locationMode != Settings.Secure.LOCATION_MODE_OFF;
		} else {
			String locationProviders = Settings.Secure.getString(reactContext.getContentResolver(),
